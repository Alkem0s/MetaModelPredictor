...
````carousel
![Linear Models Feature Importance](results/feature_importance_linear_performance.png)
<!-- slide -->
![Nonlinear Models Feature Importance](results/feature_importance_nonlinear_performance.png)
<!-- slide -->
![Tree-based Models Feature Importance](results/feature_importance_tree_performance.png)
````
...
````carousel
![Actual vs Predicted Linear (Original)](results/actual_vs_predicted_linear_performance_Original%20Dataset.png)
<!-- slide -->
![Actual vs Predicted Linear (Synthetic)](results/actual_vs_predicted_linear_performance_Synthetic%20Dataset.png)
<!-- slide -->
![Actual vs Predicted Nonlinear (Original)](results/actual_vs_predicted_nonlinear_performance_Original%20Dataset.png)
<!-- slide -->
![Actual vs Predicted Nonlinear (Synthetic)](results/actual_vs_predicted_nonlinear_performance_Synthetic%20Dataset.png)
<!-- slide -->
![Actual vs Predicted Tree-based (Original)](results/actual_vs_predicted_tree_performance_Original%20Dataset.png)
<!-- slide -->
![Actual vs Predicted Tree-based (Synthetic)](results/actual_vs_predicted_tree_performance_Synthetic%20Dataset.png)
````
